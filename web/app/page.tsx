...
const NavBar = () => (
  <nav className="fixed top-0 left-0 right-0 z-50 bg-black bg-opacity-50 backdrop-blur-md">
    <ul className="flex justify-center space-x-6 p-4">
      <li>
        <Link href="/education-portal" className="text-white hover:text-primary">
          Get Education
        </Link>
      </li>
      <li>
...
const tokenomicsData = [
  { name: 'Dynamic Liquidity Pool', value: 35, color: '#FF6384' },
  { name: 'Treasury', value: 25, color: '#36A2EB' },
  { name: 'Development & Operations', value: 20, color: '#FFCE56' },
  { name: 'Community Rewards', value: 15, color: '#4BC0C0' },
    ...
    >
      ...
      >
        <TokenomicsCard
          ...
          title="Dynamic Supply Management"
          description="Utilizes a sigmoidal bonding curve with PID controller for automated minting and burning, ensuring optimal liquidity levels."
        />
        <TokenomicsCard
          icon={<FaBrain className="text-3xl text-secondary" />}
          title="KAN-Powered Analytics"
          description="Implements Kolmogorov-Arnold Networks for predictive market analysis and conformal prediction for uncertainty estimation."
        />
        <TokenomicsCard
          icon={<FaChartLine className="text-3xl text-accent" />}
          title="Adaptive Treasury"
          description="Protocol treasury managed by AI-driven strategies to maintain long-term sustainability and fund development initiatives."
        />
        <TokenomicsCard
          icon={<FaUsers className="text-3xl text-info" />}
          title="Community Incentives"
          description="Rewards distributed to early adopters and active participants, with emphasis on long-term engagement and ecosystem growth."
        />
      </motion.div>
    </motion.div>
  );
    ...
    />
      ...
      <Section id="app-nav" title="Explore the App">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl mx-auto">
          <AppNavButton href="/education-portal">Education Portal</AppNavButton>
          <AppNavButton href="/betting-dashboard">Casino</AppNavButton>
          <AppNavButton href="/game-agent">Dashboard</AppNavButton>
          <AppNavButton href="/registry">Registry</AppNavButton>
          <AppNavButton href="/educhatbox">Chat</AppNavButton>
